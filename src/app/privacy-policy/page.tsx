...
export default function Page() {
  return (
    <div className={`px-6 pb-20 pt-16`}>
      <h1 className={`my-8 text-4xl font-bold`}>Privacy Policy</h1>
      ...
      <h3 className={`mb-4 mt-8 text-xl font-bold`}>Interpretation</h3>
      <p className={`mb-4`}>
      ...
      <h3 className={`mb-4 mt-8 text-xl font-bold`}>Definitions</h3>
      ...
      <ul className={`space-y-4`}>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Tasqboard.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Tasqboard, accessible from{" "}
            <Link
              href="https://www.tasqboard.co/"
              rel="external nofollow noopener"
              target="_blank"
              className={`link link-accent`}
            >
              https://www.tasqboard.co/
            </Link>
          </p>
        </li>
        <li>
      ...
      <h3 className={`mb-4 mt-8 text-xl font-bold`}>Types of Data Collected</h3>
      <h4 className={`mb-4 mt-8 text-lg font-bold`}>Personal Data</h4>
      <p className={`mb-4`}>
      ...
      <h4 className={`mb-4 mt-8 text-lg font-bold`}>Usage Data</h4>
      <p className={`mb-4`}>
      ...
      <h4 className={`mb-4 mt-8 text-lg font-bold`}>
      ...
      <h4 className={`mb-4 mt-8 text-lg font-bold`}>Business Transactions</h4>
      <p className={`mb-4`}>
      ...
      <h4 className={`mb-4 mt-8 text-lg font-bold`}>Law enforcement</h4>
      <p>
      ...
      <h2 className={`mb-4 mt-8 text-2xl font-bold`}>Children's Privacy</h2>
      <p className={`mb-4`}>
